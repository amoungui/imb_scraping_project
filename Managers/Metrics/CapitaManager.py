...
class CapitaManager(EntityManager):
    dataset = []
    ...
    def getyear_2018(self, tag):
        ...
        """                     
        try:
            return self.entity.__setcapita_2018__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setcapita_2018__(None)        
    ...
    def getyear_2017(self, tag):
        ...
        """                     
        try:
            return self.entity.__setcapita_2017__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setcapita_2017__(None)         
    ...
    def getyear_2016(self, tag):
        ...
        """                     
        try:
            return self.entity.__setcapita_2016__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setcapita_2016__(None)         
    ...
    def getyear_2015(self, tag):
        ...
        """                     
        try:
            return self.entity.__setcapita_2015__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setcapita_2015__(None)         
    ...
    def getyear_2014(self, tag):
        ...
        """                     
        try:
            return self.entity.__setcapita_2014__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setcapita_2014__(None)         

    def capita_to_json(self, entity):
        """ @method to_json
            @param Object: entity 
            @return List 
        ...
        data = {
            ...
            'capita_2018': entity.__capita_2018__(),
            'capita_2017': entity.__capita_2017__(),
            'capita_2016': entity.__capita_2016__(),
            'capita_2015': entity.__capita_2015__(),
            'capita_2014':entity.__capita_2014__()
        }           
        return  self.dataset.append(data)
                                
    def capita_to_csv(self):
        """ @method to_csv
            @param None: 
            @return None
        ...
        path_to_file = os.path.join(directory, "data", 'capita.csv') # with this path, we go inside the folder `data` and get the file.
        ...
        print('capita.csv has been written successfully!')                        
