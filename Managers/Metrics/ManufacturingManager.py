...
class ManufacturingManager(EntityManager):
    ...
    def getyear_2018(self, tag):
        ...
        """                     
        try:
            return self.entity.__setmanufacturing_2018__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setmanufacturing_2018__(None)        
    ...
    def getyear_2017(self, tag):
        ...
        """                     
        try:
            return self.entity.__setmanufacturing_2017__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setmanufacturing_2017__(None)         
    ...
    def getyear_2016(self, tag):
        ...
        """                     
        try:
            return self.entity.__setmanufacturing_2016__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setmanufacturing_2016__(None)         
    ...
    def getyear_2015(self, tag):
        ...
        """                     
        try:
            return self.entity.__setmanufacturing_2015__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setmanufacturing_2015__(None)         
    ...
    def getyear_2014(self, tag):
        ...
        """                     
        try:
            return self.entity.__setmanufacturing_2014__(tag.text)
        except (TypeError, AttributeError, IndexError):
    ...
    def to_json(self, entity):
        ...
        data = {
            ...
            'manufact_2018': entity.__manufacturing_2018__(),
            'manufact_2017': entity.__manufacturing_2017__(),
            'manufact_2016': entity.__manufacturing_2016__(),
            'manufact_2015': entity.__manufacturing_2015__(),
            'manufact_2014':entity.__manufacturing_2014__()
        }           
    ...
    def to_csv(self):
        ...
        path_to_file = os.path.join(directory, "data", 'manufacturing.csv') # with this path, we go inside the folder `data` and get the file.
        ...
        print('manufacturing.csv has been written successfully!')                        
