...
class MetricManager(EntityManager):
    ...
    def getyear_2018(self, tag):
        ...
        """                     
        try:
            return self.entity.__setgdp_2018__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setgdp_2018__(None)        
    ...
    def getyear_2017(self, tag):
        ...
        """                     
        try:
            return self.entity.__setgdp_2017__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setgdp_2017__(None)         
    ...
    def getyear_2016(self, tag):
        ...
        """                     
        try:
            return self.entity.__setgdp_2016__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setgdp_2016__(None)         
    ...
    def getyear_2015(self, tag):
        ...
        """                     
        try:
            return self.entity.__setgdp_2015__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setgdp_2015__(None)         
    ...
    def getyear_2014(self, tag):
        ...
        """                     
        try:
            return self.entity.__setgdp_2014__(tag.text)
        except (TypeError, AttributeError, IndexError):
    ...
    def gdp_to_json(self, entity):
        ...
        data = {
            ...
            'gdp_2018': entity.__gdp_2018__(),
            'gdp_2017': entity.__gdp_2017__(),
            'gdp_2016': entity.__gdp_2016__(),
            'gdp_2015': entity.__gdp_2015__(),
            'gdp_2014':entity.__gdp_2014__()
        }           
    ...
    def gdp_to_csv(self):
        ...
        path_to_file = os.path.join(directory, "data", 'gdp.csv') # with this path, we go inside the folder `data` and get the file.
        ...
        print('gdp.csv has been written successfully!')                        
