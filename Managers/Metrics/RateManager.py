...
class RateManager(EntityManager):
    dataset = []
    ...
    def getyear_2018(self, tag):
        ...
        """                     
        try:
            return self.entity.__setrate_2018__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setrate_2018__(None)        
    ...
    def getyear_2017(self, tag):
        ...
        """                     
        try:
            return self.entity.__setrate_2017__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setrate_2017__(None)         
    ...
    def getyear_2016(self, tag):
        ...
        """                     
        try:
            return self.entity.__setrate_2016__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setrate_2016__(None)         
    ...
    def getyear_2015(self, tag):
        ...
        """                     
        try:
            return self.entity.__setrate_2015__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setrate_2015__(None)         
    ...
    def getyear_2014(self, tag):
        ...
        """                     
        try:
            return self.entity.__setrate_2014__(tag.text)
        except (TypeError, AttributeError, IndexError):
            return self.entity.__setrate_2014__(None)         

    def rate_to_json(self, entity):
        """ @method to_json
            @param Object: entity 
            @return List 
        ...
        data = {
            ...
            'rate_2018': entity.__rate_2018__(),
            'rate_2017': entity.__rate_2017__(),
            'rate_2016': entity.__rate_2016__(),
            'rate_2015': entity.__rate_2015__(),
            'rate_2014':entity.__rate_2014__()
        }           
        return  self.dataset.append(data)
                                
    def rate_to_csv(self):
        """ @method to_csv
            @param None: 
            @return None
        ...
        path_to_file = os.path.join(directory, "data", 'rate.csv') # with this path, we go inside the folder `data` and get the file.
        ...
        print('rate.csv has been written successfully!')                        
