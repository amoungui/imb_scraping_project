...
class Capita:
    ...
    def __setcapita_2018__(self, tag):
        """ @method __setcountry__
            @param tag: 
            @return None
            @description set of the metric entity 
    ...
    def __setcapita_2017__(self, tag):
    ...
    def __setcapita_2016__(self, tag):
    ...
    def __setcapita_2015__(self, tag):
    ...
    def __setcapita_2014__(self, tag):
