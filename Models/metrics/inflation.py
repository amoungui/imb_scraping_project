...
class Inflation:
    ...
    def __setinflation_2018__(self, tag):
        """ @method __setcountry__
            @param tag: 
            @return None
            @description set of the metric entity 
    ...
    def __setinflation_2017__(self, tag):
    ...
    def __setinflation_2016__(self, tag):
    ...
    def __setinflation_2015__(self, tag):
    ...
    def __setinflation_2014__(self, tag):
