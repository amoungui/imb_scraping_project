...
class Manufacturing:
    ...
    def __manufacturing_2018__(self):
    ...
    def __manufacturing_2017__(self):
    ...
    def __manufacturing_2016__(self):
    ...
    def __manufacturing_2015__(self):
    ...
    def __manufacturing_2014__(self):
    ...
    def __setmanufacturing_2018__(self, tag):
        """ @method __setcountry__
            @param tag: 
            @return None
            @description set of the metric entity 
    ...
    def __setmanufacturing_2017__(self, tag):
    ...
    def __setmanufacturing_2016__(self, tag):
    ...
    def __setmanufacturing_2015__(self, tag):
    ...
    def __setmanufacturing_2014__(self, tag):
